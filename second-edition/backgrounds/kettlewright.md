...
> Ti si riconosce per l’odore di metallo fuso e il tintinnio dello stagno. Non sei un semplice mercante, ma un artigiano del fuoco e del metallo.
...
| **2** | Tratti in utensili e beni per la casa, vendendo le tue merci di villaggio in villaggio. Prendi **20 pezzi d’oro di oggetti** dalla tabella degli [Oggetti]({{ site.baseurl }}/second-edition/players-guide/marketplace#Oggetti). Parli correntemente il _Gergo dei Viandanti_. |
...
| **4** | Vendi oggetti rari e di qualità a monasteri e nobili. Prendi un **Cannocchiale**, una **Collana** (_minuto_) del valore di 20 pezzi d’oro e una **Pergamena** di [Passaspecchi]({{ site.baseurl }}/second-edition/wardens-guide/spellbooks) (_minuto_).                        |
...
|       |                          |                                                                                                                                                                                                |
| ----- | ------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **1** | **Uova di Fuoco**        | Sei piccole palline di sale marino, legno e polvere di ceramica. Esplodono a bassa temperatura (d8, _scoppio_) ma le fiamme si spengono rapidamente.                                           |
