...
| **2** | Un **piede** è quasi tutto metallico (calcio, d6), e tratti alcuni terreni difficili come **Facili**. Porta con te una **Tanica d'Olio** (6 utilizzi). Senza una applicazione giornaliera, diventi _privato_ e rumoroso.                                                                                                       |
| **3** | Un tuo **dito** è stato sostituito, rimpiazzando l'osso con oro e ferro. Prendi un **Gancio** e un **Cacciavite** che si possono attaccare alla punta del dito.                                                                                                                                                                |
| **4** | Entrambi le tue **orecchie** sono stati chirurgicamente potenziati, triplicando la tua capacità uditiva. Puoi concentrarti su un suono specifico, come una conversazione, a grande distanza. Indossi un lembo sull'orecchio per proteggerti dai rumori forti improvvisi (tiro salvezza su VOL per evitare la paralisi temporanea). |
...
| **4** | **Mercurio**                  | Uno stimolante. Agisci per primo in combattimento e superi automaticamente qualsiasi prova di VOL per un'ora. _Dipendente_: Salva Forza o diventa _privato_ dopo 24 ore senza di esso. 4 utilizzi. |
