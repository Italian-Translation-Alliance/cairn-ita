...
| **3** | **Mercante**          | Compri a poco e vendi a tanto, guadagnando sempre abbastanza per tirare avanti. Prendi **un singolo oggetto** del valore di **20po** (o meno) dalla tabella degli [Oggetti]({{ site.baseurl }}/second-edition/players-guide/marketplace#Oggetti). |
