...
\hypersetup{
  pdftitle={Cairn - Bestiario},
  pdfauthor={Yochai Gal},
  pdflang={it-IT},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}
\urlstyle{same} % disable monospaced font for URLs
\usepackage[papersize={5.83in,8.27in},margin=0.625in]{geometry}
...
\includepdf[pages={1}]{covers/a5/cairn-bestiary-a5-front-cover.pdf}
\end{minipage}
\AtEndDocument{\includepdf[pages={1}]{covers/a5/cairn-bestiary-a5-back-cover.pdf}}
\maketitle
\thispagestyle{empty}
\AtBeginShipoutNext{\AtBeginShipoutDiscard}
