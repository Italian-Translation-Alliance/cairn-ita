...
\usepackage[papersize={8.25in,11.75in},margin=.5in]{geometry}
...
\includepdf[pages={1}]{covers/a4/cairn-bestiary-a4-front-cover.pdf}
\end{minipage}
\AtEndDocument{\includepdf[pages={1}]{covers/a4/cairn-bestiary-a4-back-cover.pdf}}
\maketitle
\thispagestyle{empty}
\AtBeginShipoutNext{\AtBeginShipoutDiscard}
