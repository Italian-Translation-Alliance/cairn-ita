---
layout: default
title: Edizione Barebones - Regole Base
parent: Barebones
nav_order: 3
---
...
- Se un attacco porta la PF di un PG esattamente a 0, si consulta la tabella [Cicatrici](#cicatrici) per vedere come il personaggio viene influenzato in modo unico.
...
- Quando un personaggio muore, il giocatore deve creare un nuovo personaggio o prendere il controllo di un mercenario. Si uniscono immediatamente alla gruppo per ridurre i tempi di inattività.
